...
const SignUp = (): JSX.Element => {
  ...
  return (
    <section className="min-h-screen flex flex-row-reverse items-stretch text-white ">
      <div
      ...
      >
        ...
        <div className="w-full px-24 z-10">
          <HeaderText text="Greetings" />
          <p className="text-3xl my-4">We were expecting you here.</p>
        </div>
